...
public class TestBegin{
    ...
    @Test
    public void beginの束縛() throws IOException, LispException {
        String stdin = "begin";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("特殊形式beginの引数は1個以上である必要があります"));
