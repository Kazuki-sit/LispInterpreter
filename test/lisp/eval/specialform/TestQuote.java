...
public class TestQuote {
    ...
    @Test
    public void Quoteの束縛() throws IOException, LispException {
        String stdin = "quote";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("特殊形式quoteの引数は1個である必要があります"));
    ...
    @Test
    public void Quoteの省略記法での入力() throws IOException, LispException {
        String stdin = "'(1 2 3)";
