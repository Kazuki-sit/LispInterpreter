...
public class TestAppend{
    ...
    @Test
    public void appendの束縛() throws IOException, LispException {
        String stdin = "append";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きappendの引数は1個以上である必要があります"));
    ...
    public void 引数が1個() throws IOException, LispException {
        ...
        SExpression expected = ConsCell.getInstance(Int.valueOf(1), EmptyList.getInstance());
        assertThat(actual, is(expected));
    }

    @Test
    public void 引数が2個() throws IOException, LispException {
        String stdin = "(append '(1) '(2))";
    ...
    @Test(expected = LispException.class)
    public void 引数がリストでない() throws IOException, LispException {
        try {
            String stdin = "(append '(1 2 3) 4 )";
            ...
            assertThat(e.getMessage(), is("渡されたS式がリストではありません"));
            System.out.println(e.getMessage());
            throw e;
        }
