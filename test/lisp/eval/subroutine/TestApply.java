...
public class TestApply {
    ...
    @Test
    public void applyの束縛() throws IOException, LispException {
        String stdin = "apply";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きapplyの引数は2個以上である必要があります"));
    ...
    public void 引数が3個() throws IOException, LispException {
        String stdin = "(apply * '(1 2 3) '(4 5 6))";
        ...
        SExpression expected = Int.valueOf(720);
        assertThat(actual, is(expected));
    }

    @Test
    public void リストと単体の混合() throws IOException, LispException {
        String stdin = "(apply + '(1 2 3) 4 5 '(6 7))";
        ...
        SExpression expected = Int.valueOf(28);
        assertThat(actual, is(expected));
    }

    @Test
    public void 引数がラムダ式のとき() throws IOException, LispException {
        ArrayList<String> stdList = new ArrayList<>();
        stdList.add("(define x 1000)");
        stdList.add("(apply (lambda () x) ())");
