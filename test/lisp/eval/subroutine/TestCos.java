...
public class TestCos {
    ...
    @Test
    public void cosの束縛() throws IOException, LispException {
        String stdin = "cos";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きcosの引数は1個である必要があります"));
    ...
    public void 引数が1個() throws IOException, LispException {
        ...
        SExpression expected = Float.valueOf(1.0f);
        assertThat(actual, is(expected));
    }
    ...
    public void 数値以外の入力() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きcosの引数は数値である必要があります"));
            System.out.println(e.getMessage());
            throw e;
        }
    }
