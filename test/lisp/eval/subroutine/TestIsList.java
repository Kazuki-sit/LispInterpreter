...
public class TestIsList {
    ...
    @Test
    public void isListの束縛() throws IOException, LispException {
        String stdin = "list?";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きlist?の引数は1個である必要があります"));
    ...
    @Test
    public void リスト以外1() throws IOException, LispException {
        String stdin = "(null? 1)";
    ...
    @Test
    public void リスト以外2() throws IOException, LispException {
        String stdin = "(list? '(1 . 2))";
