...
public class TestIsPair {
    ...
    @Test
    public void isPairの束縛() throws IOException, LispException {
        String stdin = "pair?";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きpair?の引数は1個である必要があります"));
    ...
    @Test
    public void ドット対以外1() throws IOException, LispException {
        String stdin = "(pair? ())";
    ...
    @Test
    public void ドット対以外2() throws IOException, LispException {
        String stdin = "(pair? #t)";
