...
public class TestWrite {
    ...
    @Test
    public void writeの束縛() throws IOException, LispException {
        String stdin = "write";
    ...
    public void 引数が0個() throws IOException, LispException {
        try {
            ...
            assertThat(e.getMessage(), is("手続きwriteの引数は1個である必要があります"));
